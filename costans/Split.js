import * as images from "./photo";

const Split = [
    {
        photo: images.fiveDayPhoto,
        name: "Five-Day Split",
        price: "$200",
        description: "A five-day split training program involves working out different muscle groups on separate days throughout the week, typically focusing on one or two muscle groups per session. This allows for targeted training and adequate rest between workouts for optimal muscle growth and recovery.",
        oftenWorkOut : "5",
        time: "50 - 60 min",
        planOfEating: " 3 meals and 2 snacks per day",
    },
    {
        photo: images.p90x,
        name: "P90X",
        price: "$99",
        description: "P90X is an intense program combining cardio, strength training, and flexibility to achieve body transformation in 90 days.",
        oftenWorkOut : "6-7",
        time: "60 - 90 min",
        planOfEating: " Includes a detailed nutrition plan tailored to the exercise regimen.",
    
    },
    {
        photo:images.crossFit,
        name: "CrossFit",
        price: "$49",
        description:"CrossFit is a high-intensity functional training that blends elements from various sports and exercises.",
        oftenWorkOut : "3-5",
        time: "60 min",
